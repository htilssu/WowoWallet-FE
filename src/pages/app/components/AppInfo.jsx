import {FaRegClock, FaAppStore, FaUsers, FaRegCopy} from "react-icons/fa";
...
const AppInfo = ({ id }) => {
    ...
    // Dữ liệu giả để dùng khi không có ID
    const mockData = {
        name: "Trung Tâm Tài Chính F88",
        createdAt: "2022-01-01T00:00:00Z",
        secret: "MOCK-1234-5678-91011", // Thêm trường API Key trong dữ liệu giả
    };
    ...
    // Hàm sao chép API Key vào clipboard
    const copyToClipboard = () => {
        navigator.clipboard
            .writeText(appData.secret)
            .then(() => {
                setCopySuccess("API Key đã được sao chép!");
                setTimeout(() => setCopySuccess(""), 2000);
            })
            .catch(() => {
                setCopySuccess("Không thể sao chép API Key!");
                setTimeout(() => setCopySuccess(""), 2000);
            });
    };
    ...
    return (
        <div className="bg-gradient-to-r from-blue-50 to-white shadow-lg rounded-lg p-6 mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div className="flex items-center p-4 bg-white rounded-lg border-l-4 border-blue-500 shadow-lg hover:shadow-xl transition duration-300">
                ...
                <div className="flex items-center p-4 bg-white rounded-lg border-l-4 border-orange-500 shadow-lg hover:shadow-xl transition duration-300">
                ...
                <div className="flex items-center p-4 bg-white rounded-lg border-l-4 border-purple-500 shadow-lg hover:shadow-xl transition duration-300">
            ...
            <div className="mt-8">
                <p className="text-gray-600"><strong>Tên ứng dụng:</strong> <span
                    className="text-gray-800">{appData.name}</span></p>
                <p className="text-gray-600"><strong>Ngày tạo:</strong> <span
                    className="text-gray-800">{new Date(appData.createdAt).toLocaleDateString()}</span></p>
                <p className="text-gray-600"><strong>Người phát triển:</strong> <span
                    className="text-gray-800">Tuan Anh Junior</span></p>
                ...
                <div className="flex items-center justify-between mt-4 bg-gray-50 p-4 rounded-lg shadow-md">
                    ...
                    <div className="flex items-center space-x-2">
                        ...
                        <p className="text-sm text-gray-700">
                            {isApiKeyVisible ? appData.secret : "*********************"}
                        </p>
                        <button
