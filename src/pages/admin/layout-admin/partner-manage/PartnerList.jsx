        ...
        <div className="bg-white shadow-lg rounded-xl p-6">
            ...
            <ul className="space-y-4">
                {partners.map((partner) => (
                    ...
                    >
                        <div className="flex items-center">
                            {/* Placeholder for Partner Logo or Icon */}
                            <div className="w-12 h-12 bg-blue-100 rounded-full flex items-center justify-center mr-4">
                                ...
                                >
                                    <path
                                        d="M10 0C4.485 0 0 4.485 0 10s4.485 10 10 10 10-4.485 10-10S15.515 0 10 0zM5 10a5 5 0 0110 0 5 5 0 01-10 0z"/>
                                </svg>
                            </div>
                ...
                {statusIcons[partner.status]}
                                <span
                                    className={`ml-1 font-semibold ${partner.status === "Active" ? "text-green-600" : partner.status === "Inactive" ? "text-red-600" : "text-yellow-600"}`}>
                  {partner.status}
                </span>
              </span>
                            {/* Arrow Icon */}
