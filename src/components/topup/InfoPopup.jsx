          ...
          <form className={'mt-2 p-3'}>
            <div className="mb-4">
              ...
              <input
                  ...
                  className={`placeholder:text-lg w-full text-2xl px-3 py-2 text-red-700 font-sans ring-1 hover:ring-emerald-500 rounded-lg focus:outline-none focus:shadow-outline ${error
                                                                                                                                                                                      ? 'ring-red-500'
                                                                                                                                                                                      : 'ring-blue-500'}`}
              />
                ...
                {paymentMethods.map(({
                  ...
                  fee,
                    ...
                    <div
                        ...
                        className={`p-4 flex justify-start items-center rounded-lg border ${methodPay === label
                                                            ? 'border-blue-500 bg-blue-100'
                                                            : 'border-gray-300 bg-gray-100 hover:bg-blue-300'} cursor-pointer`}
                    >
                      {image && <img src={image} alt={label} className="flex w-1/3 mr-3"/>}
                      <div>
                        <p className={`font-semibold ${methodPay === label
                                                       ? 'text-blue-500'
