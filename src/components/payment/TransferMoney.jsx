...
const TransferMoney = () => {
  ...
  async function onVerifyOtp(/*otpCode*/) {
    try {
  ...
  async function submit() {
    transfer_v2({ ...form.values, sourceId: wallet?.id })
      .then((data) => {
                ...
                <button
                  ...
                  className={`h-10 ${
                    val === suggestAmount
                      ...
                      : "bg-white"
                  } border text-gray-700 py-2 px-4 rounded-lg hover:bg-gray-100 focus:outline-none focus:shadow-outline transition duration-300`}
                >
                  {val.toLocaleString()}
                </button>
              ))}
            ...
            <div className="mb-4">
              ...
              <TextInput
                ...
                onBlur={() => {
                  ...
                  checkUser(form.values.receiverId)
                    .then((res) => {
                      setReceiver(res);
                    })
                    .catch((e) => {
